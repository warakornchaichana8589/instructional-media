<template>
  <div class="flex justify-start items-center flex-col h-full w-full">
    ...
    <form
      @input="checkAnswers"
      class="w-full max-w-[767px] h-full flex flex-col items-center justify-center"
    >
      <div
        v-for="(item, index) in exercises.slice(4)"
        :key="index"
        class="exercise-item mt-[20px]"
      >
        <div class="flex gap-2 items-center">
          <p class="text-[22px]">ข้อที่ {{ arabicToThaiNumber(index + 5) }}.</p>
